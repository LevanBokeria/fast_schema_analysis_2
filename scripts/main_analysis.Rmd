...
## Plot mouse click heatplots for each participant, each block

```{r mouse-heat-plots, fig.width=15, fig.height=8}
...
```{r raw-learning-curves-and-fits, fig.width=13, fig.height=7}
...
#         group_by(condition,
#                  border_dist,
#                  new_pa_img_row_number_across_blocks) %>%
#         summarise(n = n(),
#                   correct_mean_across_ptp = mean(correct_mean,na.rm = T)) %>% 
#         ungroup() %>%
#         ggplot(aes(x=new_pa_img_row_number_across_blocks,
...
#         geom_line(aes(x=new_pa_img_row_number_across_blocks,
#                       y=y_hat_i_c_ml),
#                   size=1,
#                   # color='blue',
#                   linetype = 'longdash') +
